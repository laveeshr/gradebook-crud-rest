...
- After build successful, run the client project.
- A client UI will open with various options.
- Choose from the given CRUD operations and then submit the form.
- All the required fields would be updated with the received HTTP Header Information alongwith the content.
